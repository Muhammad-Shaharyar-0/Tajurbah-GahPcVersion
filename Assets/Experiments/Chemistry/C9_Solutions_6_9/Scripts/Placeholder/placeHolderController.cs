    ...
    public class placeHolderController : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (otherGameObject.transform.tag == this.transform.tag && flag == 0)
            {
                ...
                flag = 1;
                C9_Solutions_6_7.placeHolderManager.PManager_Instance.IncrementAppratusCount();
                ...
                C9_Solutions_6_7.dragObjectsController.Instance.DropAppratus();
                ...
                //{
                    otherGameObject.GetComponent<C9_Solutions_6_7.objectController>().ChangeLayerToDefault();
                //}
                this.gameObject.SetActive(false);
