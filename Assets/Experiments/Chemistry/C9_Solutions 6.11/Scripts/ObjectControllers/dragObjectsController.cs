...
namespace C9_Solutions_6_11
{
    ...
    {
        static C9_Solutions_6_11.dragObjectsController instance;
        public static C9_Solutions_6_11.dragObjectsController Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = FindObjectOfType<C9_Solutions_6_11.dragObjectsController>();
                }
                return instance;
            }
        }
