    ...
    public class placeHolderController : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (otherGameObject.transform.tag == this.transform.tag && flag == 0)
            {
                ...
                flag = 1;
                C9_Solutions_6_11.placeHolderManager.PManager_Instance.IncrementAppratusCount();
                ...
                C9_Solutions_6_11.dragObjectsController.Instance.DropAppratus();
                otherGameObject.GetComponent<objectController>().Makekinematic();

                //if (!otherGameObject.gameObject.CompareTag("FunnelPH")) // to make funnel dragable so user can observe crystals
                //{
                otherGameObject.GetComponent<C9_Solutions_6_11.objectController>().ChangeLayerToDefault();
                //}
                this.gameObject.SetActive(false);
