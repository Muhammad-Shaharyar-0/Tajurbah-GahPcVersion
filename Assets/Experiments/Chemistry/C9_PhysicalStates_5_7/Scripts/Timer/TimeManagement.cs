...
namespace C9_PhysicalStates_5_7
{
    ...
    {
        static C9_PhysicalStates_5_7.TimeManagement time_instance;
        public static C9_PhysicalStates_5_7.TimeManagement Time_instance
        {
            get
            {
                if (time_instance == null)
                {
                    time_instance = FindObjectOfType<C9_PhysicalStates_5_7.TimeManagement>();
                }
        ...
        void Start()
        {
            time_image = GameObject.Find("TimerSpeed").GetComponent<Image>();
            time_slow = GameObject.Find("TimerSlow").GetComponent<Button>();
            time_fast = GameObject.Find("TimerFast").GetComponent<Button>();
        }
        ...
        void ChangeTimescale(int time_val)
        {
            ...
            switch (time_val)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Time.timeScale = time_val * 2;
                    break;
                case 3:
                    Time.timeScale = time_val * 4;
                    break;
                case 4:
                    Time.timeScale = time_val * 8;
                    break;
            }
