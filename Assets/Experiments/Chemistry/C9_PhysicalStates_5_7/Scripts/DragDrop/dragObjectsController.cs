...
namespace C9_PhysicalStates_5_7
{
    ...
    {
        static C9_PhysicalStates_5_7.dragObjectsController instance;
        public static C9_PhysicalStates_5_7.dragObjectsController Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = FindObjectOfType<C9_PhysicalStates_5_7.dragObjectsController>();
                }
                return instance;
            }
        }
